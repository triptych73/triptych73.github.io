...
`)}function zA(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(sl).join(`
`)}function FA(r){const t=[];for(const n in r){const s=r[n];s!==!1&&t.push("#define "+n+" "+s)}return t.join(`
...
`].filter(sl).join(`
`)),u=np(u),u=fv(u,n),u=hv(u,n),h=np(h),h=fv(h,n),h=hv(h,n),u=dv(u),h=dv(h),n.isRawShaderMaterial!==!0&&(z=`#version 300 es
...
}`,mR=[new Y(1,0,0),new Y(-1,0,0),new Y(0,1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1)],gR=[new Y(0,-1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1),new Y(0,-1,0),new Y(0,-1,0)],vv=new tn,el=new Y,ad=new Y;function _R(r,t,n){let s=new gp;const l=new Pt,c=new Pt,u=new sn,h=new CE,m=new wE,p={},_=n.maxTextureSize,g={[hs]:Jn,[Jn]:hs,[ki]:ki},v=new Qi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pt},radius:{value:4}},vertexShader:dR,fragmentShader:pR}),y=v.clone();y.defines.HORIZONTAL_PASS=1;const b=new Ei;b.setAttribute("position",new ji(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const A=new Pi(b,v),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Qc;let x=this.type;this.render=function(B,O,q){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||B.length===0)return;B.type===yv&&(he("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),B.type=Qc);const T=r.getRenderTarget(),w=r.getActiveCubeFace(),I=r.getActiveMipmapLevel(),j=r.state;j.setBlending(Ta),j.buffers.depth.getReversed()===!0?j.buffers.color.setClear(0,0,0,0):j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const tt=x!==this.type;tt&&O.traverse(function(ct){ct.material&&(Array.isArray(ct.material)?ct.material.forEach(at=>at.needsUpdate=!0):ct.material.needsUpdate=!0)});for(let ct=0,at=B.length;ct<at;ct++){const F=B[ct],G=F.shadow;if(G===void 0){he("WebGLShadowMap:",F,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;l.copy(G.mapSize);const K=G.getFrameExtents();if(l.multiply(K),c.copy(G.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(c.x=Math.floor(_/K.x),l.x=c.x*K.x,G.mapSize.x=c.x),l.y>_&&(c.y=Math.floor(_/K.y),l.y=c.y*K.y,G.mapSize.y=c.y)),G.map===null||tt===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===nl){if(F.isPointLight){he("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Yi(l.x,l.y,{format:Yr,type:Ra,minFilter:Fn,magFilter:Fn,generateMipmaps:!1}),G.map.texture.name=F.name+".shadowMap",G.map.depthTexture=new fl(l.x,l.y,Xi),G.map.depthTexture.name=F.name+".shadowMapDepth",G.map.depthTexture.format=Ca,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=Nn,G.map.depthTexture.magFilter=Nn}else{F.isPointLight?(G.map=new Zv(l.x),G.map.depthTexture=new YM(l.x,Zi)):(G.map=new Yi(l.x,l.y),G.map.depthTexture=new fl(l.x,l.y,Zi)),G.map.depthTexture.name=F.name+".shadowMap",G.map.depthTexture.format=Ca;const vt=r.state.buffers.depth.getReversed();this.type===Qc?(G.map.depthTexture.compareFunction=vt?hp:fp,G.map.depthTexture.minFilter=Fn,G.map.depthTexture.magFilter=Fn):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=Nn,G.map.depthTexture.magFilter=Nn)}G.camera.updateProjectionMatrix()}const _t=G.map.isWebGLCubeRenderTarget?6:1;for(let vt=0;vt<_t;vt++){if(G.map.isWebGLCubeRenderTarget)r.setRenderTarget(G.map,vt),r.clear();else{vt===0&&(r.setRenderTarget(G.map),r.clear());const U=G.getViewport(vt);u.set(c.x*U.x,c.y*U.y,c.x*U.z,c.y*U.w),j.viewport(u)}if(F.isPointLight){const U=G.camera,$=G.matrix,ot=F.distance||U.far;ot!==U.far&&(U.far=ot,U.updateProjectionMatrix()),el.setFromMatrixPosition(F.matrixWorld),U.position.copy(el),ad.copy(U.position),ad.add(mR[vt]),U.up.copy(gR[vt]),U.lookAt(ad),U.updateMatrixWorld(),$.makeTranslation(-el.x,-el.y,-el.z),vv.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),G._frustum.setFromProjectionMatrix(vv,U.coordinateSystem,U.reversedDepth)}else G.updateMatrices(F);s=G.getFrustum(),L(O,q,G.camera,F,this.type)}G.isPointLightShadow!==!0&&this.type===nl&&z(G,q),G.needsUpdate=!1}x=this.type,M.needsUpdate=!1,r.setRenderTarget(T,w,I)};function z(B,O){const q=t.update(A);v.defines.VSM_SAMPLES!==B.blurSamples&&(v.defines.VSM_SAMPLES=B.blurSamples,y.defines.VSM_SAMPLES=B.blurSamples,v.needsUpdate=!0,y.needsUpdate=!0),B.mapPass===null&&(B.mapPass=new Yi(l.x,l.y,{format:Yr,type:Ra})),v.uniforms.shadow_pass.value=B.map.depthTexture,v.uniforms.resolution.value=B.mapSize,v.uniforms.radius.value=B.radius,r.setRenderTarget(B.mapPass),r.clear(),r.renderBufferDirect(O,null,q,v,A,null),y.uniforms.shadow_pass.value=B.mapPass.texture,y.uniforms.resolution.value=B.mapSize,y.uniforms.radius.value=B.radius,r.setRenderTarget(B.map),r.clear(),r.renderBufferDirect(O,null,q,y,A,null)}function D(B,O,q,T){let w=null;const I=q.isPointLight===!0?B.customDistanceMaterial:B.customDepthMaterial;if(I!==void 0)w=I;else if(w=q.isPointLight===!0?m:h,r.localClippingEnabled&&O.clipShadows===!0&&Array.isArray(O.clippingPlanes)&&O.clippingPlanes.length!==0||O.displacementMap&&O.displacementScale!==0||O.alphaMap&&O.alphaTest>0||O.map&&O.alphaTest>0||O.alphaToCoverage===!0){const j=w.uuid,tt=O.uuid;let ct=p[j];ct===void 0&&(ct={},p[j]=ct);let at=ct[tt];at===void 0&&(at=w.clone(),ct[tt]=at,O.addEventListener("dispose",H)),w=at}if(w.visible=O.visible,w.wireframe=O.wireframe,T===nl?w.side=O.shadowSide!==null?O.shadowSide:O.side:w.side=O.shadowSide!==null?O.shadowSide:g[O.side],w.alphaMap=O.alphaMap,w.alphaTest=O.alphaToCoverage===!0?.5:O.alphaTest,w.map=O.map,w.clipShadows=O.clipShadows,w.clippingPlanes=O.clippingPlanes,w.clipIntersection=O.clipIntersection,w.displacementMap=O.displacementMap,w.displacementScale=O.displacementScale,w.displacementBias=O.displacementBias,w.wireframeLinewidth=O.wireframeLinewidth,w.linewidth=O.linewidth,q.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const j=r.properties.get(w);j.light=q}return w}function L(B,O,q,T,w){if(B.visible===!1)return;if(B.layers.test(O.layers)&&(B.isMesh||B.isLine||B.isPoints)&&(B.castShadow||B.receiveShadow&&w===nl)&&(!B.frustumCulled||s.intersectsObject(B))){B.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,B.matrixWorld);const tt=t.update(B),ct=B.material;if(Array.isArray(ct)){const at=tt.groups;for(let F=0,G=at.length;F<G;F++){const K=at[F],_t=ct[K.materialIndex];if(_t&&_t.visible){const vt=D(B,_t,T,w);B.onBeforeShadow(r,B,O,q,tt,vt,K),r.renderBufferDirect(q,null,tt,vt,B,K),B.onAfterShadow(r,B,O,q,tt,vt,K)}}}else if(ct.visible){const at=D(B,ct,T,w);B.onBeforeShadow(r,B,O,q,tt,at,null),r.renderBufferDirect(q,null,tt,at,B,null),B.onAfterShadow(r,B,O,q,tt,at,null)}}const j=B.children;for(let tt=0,ct=j.length;tt<ct;tt++)L(j[tt],O,q,T,w)}function H(B){B.target.removeEventListener("dispose",H);for(const q in p){const T=p[q],w=B.target.uuid;w in T&&(T[w].dispose(),delete T[w])}}}const vR={[ld]:cd,[ud]:dd,[fd]:pd,[Wr]:hd,[cd]:ld,[dd]:ud,[pd]:fd,[hd]:Wr};function xR(r,t){function n(){let W=!1;const zt=new sn;let Ct=null;const kt=new sn(0,0,0,0);return{setMask:function(Tt){Ct!==Tt&&!W&&(r.colorMask(Tt,Tt,Tt,Tt),Ct=Tt)},setLocked:function(Tt){W=Tt},setClear:function(Tt,yt,Nt,ue,Ue){Ue===!0&&(Tt*=ue,yt*=ue,Nt*=ue),zt.set(Tt,yt,Nt,ue),kt.equals(zt)===!1&&(r.clearColor(Tt,yt,Nt,ue),kt.copy(zt))},reset:function(){W=!1,Ct=null,kt.set(-1,0,0,0)}}}function s(){let W=!1,zt=!1,Ct=null,kt=null,Tt=null;return{setReversed:function(yt){if(zt!==yt){const Nt=t.get("EXT_clip_control");yt?Nt.clipControlEXT(Nt.LOWER_LEFT_EXT,Nt.ZERO_TO_ONE_EXT):Nt.clipControlEXT(Nt.LOWER_LEFT_EXT,Nt.NEGATIVE_ONE_TO_ONE_EXT),zt=yt;const ue=Tt;Tt=null,this.setClear(ue)}},getReversed:function(){return zt},setTest:function(yt){yt?dt(r.DEPTH_TEST):Dt(r.DEPTH_TEST)},setMask:function(yt){Ct!==yt&&!W&&(r.depthMask(yt),Ct=yt)},setFunc:function(yt){if(zt&&(yt=vR[yt]),kt!==yt){switch(yt){case ld:r.depthFunc(r.NEVER);break;case cd:r.depthFunc(r.ALWAYS);break;case ud:r.depthFunc(r.LESS);break;case Wr:r.depthFunc(r.LEQUAL);break;case fd:r.depthFunc(r.EQUAL);break;case hd:r.depthFunc(r.GEQUAL);break;case dd:r.depthFunc(r.GREATER);break;case pd:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}kt=yt}},setLocked:function(yt){W=yt},setClear:function(yt){Tt!==yt&&(zt&&(yt=1-yt),r.clearDepth(yt),Tt=yt)},reset:function(){W=!1,Ct=null,kt=null,Tt=null,zt=!1}}}function l(){let W=!1,zt=null,Ct=null,kt=null,Tt=null,yt=null,Nt=null,ue=null,Ue=null;return{setTest:function(Te){W||(Te?dt(r.STENCIL_TEST):Dt(r.STENCIL_TEST))},setMask:function(Te){zt!==Te&&!W&&(r.stencilMask(Te),zt=Te)},setFunc:function(Te,pn,Vn){(Ct!==Te||kt!==pn||Tt!==Vn)&&(r.stencilFunc(Te,pn,Vn),Ct=Te,kt=pn,Tt=Vn)},setOp:function(Te,pn,Vn){(yt!==Te||Nt!==pn||ue!==Vn)&&(r.stencilOp(Te,pn,Vn),yt=Te,Nt=pn,ue=Vn)},setLocked:function(Te){W=Te},setClear:function(Te){Ue!==Te&&(r.clearStencil(Te),Ue=Te)},reset:function(){W=!1,zt=null,Ct=null,kt=null,Tt=null,yt=null,Nt=null,ue=null,Ue=null}}}const c=new n,u=new s,h=new l,m=new WeakMap,p=new WeakMap;let _={},g={},v=new WeakMap,y=[],b=null,A=!1,M=null,x=null,z=null,D=null,L=null,H=null,B=null,O=new Ce(0,0,0),q=0,T=!1,w=null,I=null,j=null,tt=null,ct=null;const at=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,G=0;const K=r.getParameter(r.VERSION);K.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(K)[1]),F=G>=1):K.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),F=G>=2);let _t=null,vt={};const U=r.getParameter(r.SCISSOR_BOX),$=r.getParameter(r.VIEWPORT),ot=new sn().fromArray(U),Rt=new sn().fromArray($);function Gt(W,zt,Ct,kt){const Tt=new Uint8Array(4),yt=r.createTexture();r.bindTexture(W,yt),r.texParameteri(W,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(W,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Nt=0;Nt<Ct;Nt++)W===r.TEXTURE_3D||W===r.TEXTURE_2D_ARRAY?r.texImage3D(zt,0,r.RGBA,1,1,kt,0,r.RGBA,r.UNSIGNED_BYTE,Tt):r.texImage2D(zt+Nt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,Tt);return yt}const nt={};nt[r.TEXTURE_2D]=Gt(r.TEXTURE_2D,r.TEXTURE_2D,1),nt[r.TEXTURE_CUBE_MAP]=Gt(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),nt[r.TEXTURE_2D_ARRAY]=Gt(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),nt[r.TEXTURE_3D]=Gt(r.TEXTURE_3D,r.TEXTURE_3D,1,1),c.setClear(0,0,0,1),u.setClear(1),h.setClear(0),dt(r.DEPTH_TEST),u.setFunc(Wr),Et(!1),Ft(u_),dt(r.CULL_FACE),xt(Ta);function dt(W){_[W]!==!0&&(r.enable(W),_[W]=!0)}function Dt(W){_[W]!==!1&&(r.disable(W),_[W]=!1)}function Vt(W,zt){return g[W]!==zt?(r.bindFramebuffer(W,zt),g[W]=zt,W===r.DRAW_FRAMEBUFFER&&(g[r.FRAMEBUFFER]=zt),W===r.FRAMEBUFFER&&(g[r.DRAW_FRAMEBUFFER]=zt),!0):!1}function Wt(W,zt){let Ct=y,kt=!1;if(W){Ct=v.get(zt),Ct===void 0&&(Ct=[],v.set(zt,Ct));const Tt=W.textures;if(Ct.length!==Tt.length||Ct[0]!==r.COLOR_ATTACHMENT0){for(let yt=0,Nt=Tt.length;yt<Nt;yt++)Ct[yt]=r.COLOR_ATTACHMENT0+yt;Ct.length=Tt.length,kt=!0}}else Ct[0]!==r.BACK&&(Ct[0]=r.BACK,kt=!0);kt&&r.drawBuffers(Ct)}function pe(W){return b!==W?(r.useProgram(W),b=W,!0):!1}const ge={[Is]:r.FUNC_ADD,[By]:r.FUNC_SUBTRACT,[Hy]:r.FUNC_REVERSE_SUBTRACT};ge[Gy]=r.MIN,ge[Vy]=r.MAX;const fe={[ky]:r.ZERO,[Xy]:r.ONE,[Wy]:r.SRC_COLOR,[rd]:r.SRC_ALPHA,[Qy]:r.SRC_ALPHA_SATURATE,[Zy]:r.DST_COLOR,[Yy]:r.DST_ALPHA,[qy]:r.ONE_MINUS_SRC_COLOR,[od]:r.ONE_MINUS_SRC_ALPHA,[Ky]:r.ONE_MINUS_DST_COLOR,[jy]:r.ONE_MINUS_DST_ALPHA,[Jy]:r.CONSTANT_COLOR,[$y]:r.ONE_MINUS_CONSTANT_COLOR,[tM]:r.CONSTANT_ALPHA,[eM]:r.ONE_MINUS_CONSTANT_ALPHA};function xt(W,zt,Ct,kt,Tt,yt,Nt,ue,Ue,Te){if(W===Ta){A===!0&&(Dt(r.BLEND),A=!1);return}if(A===!1&&(dt(r.BLEND),A=!0),W!==Iy){if(W!==M||Te!==T){if((x!==Is||L!==Is)&&(r.blendEquation(r.FUNC_ADD),x=Is,L=Is),Te)switch(W){case kr:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case f_:r.blendFunc(r.ONE,r.ONE);break;case h_:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case d_:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:Le("WebGLState: Invalid blending: ",W);break}else switch(W){case kr:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case f_:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case h_:Le("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case d_:Le("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Le("WebGLState: Invalid blending: ",W);break}z=null,D=null,H=null,B=null,O.set(0,0,0),q=0,M=W,T=Te}return}Tt=Tt||zt,yt=yt||Ct,Nt=Nt||kt,(zt!==x||Tt!==L)&&(r.blendEquationSeparate(ge[zt],ge[Tt]),x=zt,L=Tt),(Ct!==z||kt!==D||yt!==H||Nt!==B)&&(r.blendFuncSeparate(fe[Ct],fe[kt],fe[yt],fe[Nt]),z=Ct,D=kt,H=yt,B=Nt),(ue.equals(O)===!1||Ue!==q)&&(r.blendColor(ue.r,ue.g,ue.b,Ue),O.copy(ue),q=Ue),M=W,T=!1}function At(W,zt){W.side===ki?Dt(r.CULL_FACE):dt(r.CULL_FACE);let Ct=W.side===Jn;zt&&(Ct=!Ct),Et(Ct),W.blending===kr&&W.transparent===!1?xt(Ta):xt(W.blending,W.blendEquation,W.blendSrc,W.blendDst,W.blendEquationAlpha,W.blendSrcAlpha,W.blendDstAlpha,W.blendColor,W.blendAlpha,W.premultipliedAlpha),u.setFunc(W.depthFunc),u.setTest(W.depthTest),u.setMask(W.depthWrite),c.setMask(W.colorWrite);const kt=W.stencilWrite;h.setTest(kt),kt&&(h.setMask(W.stencilWriteMask),h.setFunc(W.stencilFunc,W.stencilRef,W.stencilFuncMask),h.setOp(W.stencilFail,W.stencilZFail,W.stencilZPass)),ne(W.polygonOffset,W.polygonOffsetFactor,W.polygonOffsetUnits),W.alphaToCoverage===!0?dt(r.SAMPLE_ALPHA_TO_COVERAGE):Dt(r.SAMPLE_ALPHA_TO_COVERAGE)}function Et(W){w!==W&&(W?r.frontFace(r.CW):r.frontFace(r.CCW),w=W)}function Ft(W){W!==zy?(dt(r.CULL_FACE),W!==I&&(W===u_?r.cullFace(r.BACK):W===Fy?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Dt(r.CULL_FACE),I=W}function P(W){W!==j&&(F&&r.lineWidth(W),j=W)}function ne(W,zt,Ct){W?(dt(r.POLYGON_OFFSET_FILL),(tt!==zt||ct!==Ct)&&(r.polygonOffset(zt,Ct),tt=zt,ct=Ct)):Dt(r.POLYGON_OFFSET_FILL)}function Ht(W){W?dt(r.SCISSOR_TEST):Dt(r.SCISSOR_TEST)}function ie(W){W===void 0&&(W=r.TEXTURE0+at-1),_t!==W&&(r.activeTexture(W),_t=W)}function Lt(W,zt,Ct){Ct===void 0&&(_t===null?Ct=r.TEXTURE0+at-1:Ct=_t);let kt=vt[Ct];kt===void 0&&(kt={type:void 0,texture:void 0},vt[Ct]=kt),(kt.type!==W||kt.texture!==zt)&&(_t!==Ct&&(r.activeTexture(Ct),_t=Ct),r.bindTexture(W,zt||nt[W]),kt.type=W,kt.texture=zt)}function N(){const W=vt[_t];W!==void 0&&W.type!==void 0&&(r.bindTexture(W.type,null),W.type=void 0,W.texture=void 0)}function E(){try{r.compressedTexImage2D(...arguments)}catch(W){Le("WebGLState:",W)}}function X(){try{r.compressedTexImage3D(...arguments)}catch(W){Le("WebGLState:",W)}}function ut(){try{r.texSubImage2D(...arguments)}catch(W){Le("WebGLState:",W)}}function mt(){try{r.texSubImage3D(...arguments)}catch(W){Le("WebGLState:",W)}}function ft(){try{r.compressedTexSubImage2D(...arguments)}catch(W){Le("WebGLState:",W)}}function Zt(){try{r.compressedTexSubImage3D(...arguments)}catch(W){Le("WebGLState:",W)}}function Ut(){try{r.texStorage2D(...arguments)}catch(W){Le("WebGLState:",W)}}function jt(){try{r.texStorage3D(...arguments)}catch(W){Le("WebGLState:",W)}}function se(){try{r.texImage2D(...arguments)}catch(W){Le("WebGLState:",W)}}function bt(){try{r.texImage3D(...arguments)}catch(W){Le("WebGLState:",W)}}function wt(W){ot.equals(W)===!1&&(r.scissor(W.x,W.y,W.z,W.w),ot.copy(W))}function Yt(W){Rt.equals(W)===!1&&(r.viewport(W.x,W.y,W.z,W.w),Rt.copy(W))}function It(W,zt){let Ct=p.get(zt);Ct===void 0&&(Ct=new WeakMap,p.set(zt,Ct));let kt=Ct.get(W);kt===void 0&&(kt=r.getUniformBlockIndex(zt,W.name),Ct.set(W,kt))}function Ot(W,zt){const kt=p.get(zt).get(W);m.get(zt)!==kt&&(r.uniformBlockBinding(zt,kt,W.__bindingPointIndex),m.set(zt,kt))}function _e(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),u.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),_={},_t=null,vt={},g={},v=new WeakMap,y=[],b=null,A=!1,M=null,x=null,z=null,D=null,L=null,H=null,B=null,O=new Ce(0,0,0),q=0,T=!1,w=null,I=null,j=null,tt=null,ct=null,ot.set(0,0,r.canvas.width,r.canvas.height),Rt.set(0,0,r.canvas.width,r.canvas.height),c.reset(),u.reset(),h.reset()}return{buffers:{color:c,depth:u,stencil:h},enable:dt,disable:Dt,bindFramebuffer:Vt,drawBuffers:Wt,useProgram:pe,setBlending:xt,setMaterial:At,setFlipSided:Et,setCullFace:Ft,setLineWidth:P,setPolygonOffset:ne,setScissorTest:Ht,activeTexture:ie,bindTexture:Lt,unbindTexture:N,compressedTexImage2D:E,compressedTexImage3D:X,texImage2D:se,texImage3D:bt,updateUBOMapping:It,uniformBlockBinding:Ot,texStorage2D:Ut,texStorage3D:jt,texSubImage2D:ut,texSubImage3D:mt,compressedTexSubImage2D:ft,compressedTexSubImage3D:Zt,scissor:wt,viewport:Yt,reset:_e}}function SR(r,t,n,s,l,c,u){const h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Pt,_=new WeakMap;let g;const v=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(N,E){return y?new OffscreenCanvas(N,E):ru("canvas")}function A(N,E,X){let ut=1;const mt=Lt(N);if((mt.width>X||mt.height>X)&&(ut=X/Math.max(mt.width,mt.height)),ut<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const ft=Math.floor(ut*mt.width),Zt=Math.floor(ut*mt.height);g===void 0&&(g=b(ft,Zt));const Ut=E?b(ft,Zt):g;return Ut.width=ft,Ut.height=Zt,Ut.getContext("2d").drawImage(N,0,0,ft,Zt),he("WebGLRenderer: Texture has been resized from ("+mt.width+"x"+mt.height+") to ("+ft+"x"+Zt+")."),Ut}else return"data"in N&&he("WebGLRenderer: Image in DataTexture is too big ("+mt.width+"x"+mt.height+")."),N;return N}function M(N){return N.generateMipmaps}function x(N){r.generateMipmap(N)}function z(N){return N.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:N.isWebGL3DRenderTarget?r.TEXTURE_3D:N.isWebGLArrayRenderTarget||N.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function D(N,E,X,ut,mt=!1){if(N!==null){if(r[N]!==void 0)return r[N];he("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let ft=E;if(E===r.RED&&(X===r.FLOAT&&(ft=r.R32F),X===r.HALF_FLOAT&&(ft=r.R16F),X===r.UNSIGNED_BYTE&&(ft=r.R8)),E===r.RED_INTEGER&&(X===r.UNSIGNED_BYTE&&(ft=r.R8UI),X===r.UNSIGNED_SHORT&&(ft=r.R16UI),X===r.UNSIGNED_INT&&(ft=r.R32UI),X===r.BYTE&&(ft=r.R8I),X===r.SHORT&&(ft=r.R16I),X===r.INT&&(ft=r.R32I)),E===r.RG&&(X===r.FLOAT&&(ft=r.RG32F),X===r.HALF_FLOAT&&(ft=r.RG16F),X===r.UNSIGNED_BYTE&&(ft=r.RG8)),E===r.RG_INTEGER&&(X===r.UNSIGNED_BYTE&&(ft=r.RG8UI),X===r.UNSIGNED_SHORT&&(ft=r.RG16UI),X===r.UNSIGNED_INT&&(ft=r.RG32UI),X===r.BYTE&&(ft=r.RG8I),X===r.SHORT&&(ft=r.RG16I),X===r.INT&&(ft=r.RG32I)),E===r.RGB_INTEGER&&(X===r.UNSIGNED_BYTE&&(ft=r.RGB8UI),X===r.UNSIGNED_SHORT&&(ft=r.RGB16UI),X===r.UNSIGNED_INT&&(ft=r.RGB32UI),X===r.BYTE&&(ft=r.RGB8I),X===r.SHORT&&(ft=r.RGB16I),X===r.INT&&(ft=r.RGB32I)),E===r.RGBA_INTEGER&&(X===r.UNSIGNED_BYTE&&(ft=r.RGBA8UI),X===r.UNSIGNED_SHORT&&(ft=r.RGBA16UI),X===r.UNSIGNED_INT&&(ft=r.RGBA32UI),X===r.BYTE&&(ft=r.RGBA8I),X===r.SHORT&&(ft=r.RGBA16I),X===r.INT&&(ft=r.RGBA32I)),E===r.RGB&&(X===r.UNSIGNED_INT_5_9_9_9_REV&&(ft=r.RGB9_E5),X===r.UNSIGNED_INT_10F_11F_11F_REV&&(ft=r.R11F_G11F_B10F)),E===r.RGBA){const Zt=mt?au:Ne.getTransfer(ut);X===r.FLOAT&&(ft=r.RGBA32F),X===r.HALF_FLOAT&&(ft=r.RGBA16F),X===r.UNSIGNED_BYTE&&(ft=Zt===ke?r.SRGB8_ALPHA8:r.RGBA8),X===r.UNSIGNED_SHORT_4_4_4_4&&(ft=r.RGBA4),X===r.UNSIGNED_SHORT_5_5_5_1&&(ft=r.RGB5_A1)}return(ft===r.R16F||ft===r.R32F||ft===r.RG16F||ft===r.RG32F||ft===r.RGBA16F||ft===r.RGBA32F)&&t.get("EXT_color_buffer_float"),ft}function L(N,E){let X;return N?E===null||E===Zi||E===cl?X=r.DEPTH24_STENCIL8:E===Xi?X=r.DEPTH32F_STENCIL8:E===ll&&(X=r.DEPTH24_STENCIL8,he("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Zi||E===cl?X=r.DEPTH_COMPONENT24:E===Xi?X=r.DEPTH_COMPONENT32F:E===ll&&(X=r.DEPTH_COMPONENT16),X}function H(N,E){return M(N)===!0||N.isFramebufferTexture&&N.minFilter!==Nn&&N.minFilter!==Fn?Math.log2(Math.max(E.width,E.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?E.mipmaps.length:1}function B(N){const E=N.target;E.removeEventListener("dispose",B),q(E),E.isVideoTexture&&_.delete(E)}function O(N){const E=N.target;E.removeEventListener("dispose",O),w(E)}function q(N){const E=s.get(N);if(E.__webglInit===void 0)return;const X=N.source,ut=v.get(X);if(ut){const mt=ut[E.__cacheKey];mt.usedTimes--,mt.usedTimes===0&&T(N),Object.keys(ut).length===0&&v.delete(X)}s.remove(N)}function T(N){const E=s.get(N);r.deleteTexture(E.__webglTexture);const X=N.source,ut=v.get(X);delete ut[E.__cacheKey],u.memory.textures--}function w(N){const E=s.get(N);if(N.depthTexture&&(N.depthTexture.dispose(),s.remove(N.depthTexture)),N.isWebGLCubeRenderTarget)for(let ut=0;ut<6;ut++){if(Array.isArray(E.__webglFramebuffer[ut]))for(let mt=0;mt<E.__webglFramebuffer[ut].length;mt++)r.deleteFramebuffer(E.__webglFramebuffer[ut][mt]);else r.deleteFramebuffer(E.__webglFramebuffer[ut]);E.__webglDepthbuffer&&r.deleteRenderbuffer(E.__webglDepthbuffer[ut])}else{if(Array.isArray(E.__webglFramebuffer))for(let ut=0;ut<E.__webglFramebuffer.length;ut++)r.deleteFramebuffer(E.__webglFramebuffer[ut]);else r.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&r.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&r.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ut=0;ut<E.__webglColorRenderbuffer.length;ut++)E.__webglColorRenderbuffer[ut]&&r.deleteRenderbuffer(E.__webglColorRenderbuffer[ut]);E.__webglDepthRenderbuffer&&r.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const X=N.textures;for(let ut=0,mt=X.length;ut<mt;ut++){const ft=s.get(X[ut]);ft.__webglTexture&&(r.deleteTexture(ft.__webglTexture),u.memory.textures--),s.remove(X[ut])}s.remove(N)}let I=0;function j(){I=0}function tt(){const N=I;return N>=l.maxTextures&&he("WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+l.maxTextures),I+=1,N}function ct(N){const E=[];return E.push(N.wrapS),E.push(N.wrapT),E.push(N.wrapR||0),E.push(N.magFilter),E.push(N.minFilter),E.push(N.anisotropy),E.push(N.internalFormat),E.push(N.format),E.push(N.type),E.push(N.generateMipmaps),E.push(N.premultiplyAlpha),E.push(N.flipY),E.push(N.unpackAlignment),E.push(N.colorSpace),E.join()}function at(N,E){const X=s.get(N);if(N.isVideoTexture&&Ht(N),N.isRenderTargetTexture===!1&&N.isExternalTexture!==!0&&N.version>0&&X.__version!==N.version){const ut=N.image;if(ut===null)he("WebGLRenderer: Texture marked for update but no image data found.");else if(ut.complete===!1)he("WebGLRenderer: Texture marked for update but image is incomplete");else{nt(X,N,E);return}}else N.isExternalTexture&&(X.__webglTexture=N.sourceTexture?N.sourceTexture:null);n.bindTexture(r.TEXTURE_2D,X.__webglTexture,r.TEXTURE0+E)}function F(N,E){const X=s.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&X.__version!==N.version){nt(X,N,E);return}else N.isExternalTexture&&(X.__webglTexture=N.sourceTexture?N.sourceTexture:null);n.bindTexture(r.TEXTURE_2D_ARRAY,X.__webglTexture,r.TEXTURE0+E)}function G(N,E){const X=s.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&X.__version!==N.version){nt(X,N,E);return}n.bindTexture(r.TEXTURE_3D,X.__webglTexture,r.TEXTURE0+E)}function K(N,E){const X=s.get(N);if(N.isCubeDepthTexture!==!0&&N.version>0&&X.__version!==N.version){dt(X,N,E);return}n.bindTexture(r.TEXTURE_CUBE_MAP,X.__webglTexture,r.TEXTURE0+E)}const _t={[_d]:r.REPEAT,[ba]:r.CLAMP_TO_EDGE,[vd]:r.MIRRORED_REPEAT},vt={[Nn]:r.NEAREST,[aM]:r.NEAREST_MIPMAP_NEAREST,[Tc]:r.NEAREST_MIPMAP_LINEAR,[Fn]:r.LINEAR,[bh]:r.LINEAR_MIPMAP_NEAREST,[Hs]:r.LINEAR_MIPMAP_LINEAR},U={[oM]:r.NEVER,[hM]:r.ALWAYS,[lM]:r.LESS,[fp]:r.LEQUAL,[cM]:r.EQUAL,[hp]:r.GEQUAL,[uM]:r.GREATER,[fM]:r.NOTEQUAL};function $(N,E){if(E.type===Xi&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===Fn||E.magFilter===bh||E.magFilter===Tc||E.magFilter===Hs||E.minFilter===Fn||E.minFilter===bh||E.minFilter===Tc||E.minFilter===Hs)&&he("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(N,r.TEXTURE_WRAP_S,_t[E.wrapS]),r.texParameteri(N,r.TEXTURE_WRAP_T,_t[E.wrapT]),(N===r.TEXTURE_3D||N===r.TEXTURE_2D_ARRAY)&&r.texParameteri(N,r.TEXTURE_WRAP_R,_t[E.wrapR]),r.texParameteri(N,r.TEXTURE_MAG_FILTER,vt[E.magFilter]),r.texParameteri(N,r.TEXTURE_MIN_FILTER,vt[E.minFilter]),E.compareFunction&&(r.texParameteri(N,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(N,r.TEXTURE_COMPARE_FUNC,U[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Nn||E.minFilter!==Tc&&E.minFilter!==Hs||E.type===Xi&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||s.get(E).__currentAnisotropy){const X=t.get("EXT_texture_filter_anisotropic");r.texParameterf(N,X.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),s.get(E).__currentAnisotropy=E.anisotropy}}}function ot(N,E){let X=!1;N.__webglInit===void 0&&(N.__webglInit=!0,E.addEventListener("dispose",B));const ut=E.source;let mt=v.get(ut);mt===void 0&&(mt={},v.set(ut,mt));const ft=ct(E);if(ft!==N.__cacheKey){mt[ft]===void 0&&(mt[ft]={texture:r.createTexture(),usedTimes:0},u.memory.textures++,X=!0),mt[ft].usedTimes++;const Zt=mt[N.__cacheKey];Zt!==void 0&&(mt[N.__cacheKey].usedTimes--,Zt.usedTimes===0&&T(E)),N.__cacheKey=ft,N.__webglTexture=mt[ft].texture}return X}function Rt(N,E,X){return Math.floor(Math.floor(N/X)/E)}function Gt(N,E,X,ut){const ft=N.updateRanges;if(ft.length===0)n.texSubImage2D(r.TEXTURE_2D,0,0,0,E.width,E.height,X,ut,E.data);else{ft.sort((bt,wt)=>bt.start-wt.start);let Zt=0;for(let bt=1;bt<ft.length;bt++){const wt=ft[Zt],Yt=ft[bt],It=wt.start+wt.count,Ot=Rt(Yt.start,E.width,4),_e=Rt(wt.start,E.width,4);Yt.start<=It+1&&Ot===_e&&Rt(Yt.start+Yt.count-1,E.width,4)===Ot?wt.count=Math.max(wt.count,Yt.start+Yt.count-wt.start):(++Zt,ft[Zt]=Yt)}ft.length=Zt+1;const Ut=r.getParameter(r.UNPACK_ROW_LENGTH),jt=r.getParameter(r.UNPACK_SKIP_PIXELS),se=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,E.width);for(let bt=0,wt=ft.length;bt<wt;bt++){const Yt=ft[bt],It=Math.floor(Yt.start/4),Ot=Math.ceil(Yt.count/4),_e=It%E.width,W=Math.floor(It/E.width),zt=Ot,Ct=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,_e),r.pixelStorei(r.UNPACK_SKIP_ROWS,W),n.texSubImage2D(r.TEXTURE_2D,0,_e,W,zt,Ct,X,ut,E.data)}N.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,Ut),r.pixelStorei(r.UNPACK_SKIP_PIXELS,jt),r.pixelStorei(r.UNPACK_SKIP_ROWS,se)}}function nt(N,E,X){let ut=r.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ut=r.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ut=r.TEXTURE_3D);const mt=ot(N,E),ft=E.source;n.bindTexture(ut,N.__webglTexture,r.TEXTURE0+X);const Zt=s.get(ft);if(ft.version!==Zt.__version||mt===!0){n.activeTexture(r.TEXTURE0+X);const Ut=Ne.getPrimaries(Ne.workingColorSpace),jt=E.colorSpace===us?null:Ne.getPrimaries(E.colorSpace),se=E.colorSpace===us||Ut===jt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,E.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,E.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,se);let bt=A(E.image,!1,l.maxTextureSize);bt=ie(E,bt);const wt=c.convert(E.format,E.colorSpace),Yt=c.convert(E.type);let It=D(E.internalFormat,wt,Yt,E.colorSpace,E.isVideoTexture);$(ut,E);let Ot;const _e=E.mipmaps,W=E.isVideoTexture!==!0,zt=Zt.__version===void 0||mt===!0,Ct=ft.dataReady,kt=H(E,bt);if(E.isDepthTexture)It=L(E.format===Gs,E.type),zt&&(W?n.texStorage2D(r.TEXTURE_2D,1,It,bt.width,bt.height):n.texImage2D(r.TEXTURE_2D,0,It,bt.width,bt.height,0,wt,Yt,null));else if(E.isDataTexture)if(_e.length>0){W&&zt&&n.texStorage2D(r.TEXTURE_2D,kt,It,_e[0].width,_e[0].height);for(let Tt=0,yt=_e.length;Tt<yt;Tt++)Ot=_e[Tt],W?Ct&&n.texSubImage2D(r.TEXTURE_2D,Tt,0,0,Ot.width,Ot.height,wt,Yt,Ot.data):n.texImage2D(r.TEXTURE_2D,Tt,It,Ot.width,Ot.height,0,wt,Yt,Ot.data);E.generateMipmaps=!1}else W?(zt&&n.texStorage2D(r.TEXTURE_2D,kt,It,bt.width,bt.height),Ct&&Gt(E,bt,wt,Yt)):n.texImage2D(r.TEXTURE_2D,0,It,bt.width,bt.height,0,wt,Yt,bt.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){W&&zt&&n.texStorage3D(r.TEXTURE_2D_ARRAY,kt,It,_e[0].width,_e[0].height,bt.depth);for(let Tt=0,yt=_e.length;Tt<yt;Tt++)if(Ot=_e[Tt],E.format!==Oi)if(wt!==null)if(W){if(Ct)if(E.layerUpdates.size>0){const Nt=Z_(Ot.width,Ot.height,E.format,E.type);for(const ue of E.layerUpdates){const Ue=Ot.data.subarray(ue*Nt/Ot.data.BYTES_PER_ELEMENT,(ue+1)*Nt/Ot.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Tt,0,0,ue,Ot.width,Ot.height,1,wt,Ue)}E.clearLayerUpdates()}else n.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Tt,0,0,0,Ot.width,Ot.height,bt.depth,wt,Ot.data)}else n.compressedTexImage3D(r.TEXTURE_2D_ARRAY,Tt,It,Ot.width,Ot.height,bt.depth,0,Ot.data,0,0);else he("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else W?Ct&&n.texSubImage3D(r.TEXTURE_2D_ARRAY,Tt,0,0,0,Ot.width,Ot.height,bt.depth,wt,Yt,Ot.data):n.texImage3D(r.TEXTURE_2D_ARRAY,Tt,It,Ot.width,Ot.height,bt.depth,0,wt,Yt,Ot.data)}else{W&&zt&&n.texStorage2D(r.TEXTURE_2D,kt,It,_e[0].width,_e[0].height);for(let Tt=0,yt=_e.length;Tt<yt;Tt++)Ot=_e[Tt],E.format!==Oi?wt!==null?W?Ct&&n.compressedTexSubImage2D(r.TEXTURE_2D,Tt,0,0,Ot.width,Ot.height,wt,Ot.data):n.compressedTexImage2D(r.TEXTURE_2D,Tt,It,Ot.width,Ot.height,0,Ot.data):he("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):W?Ct&&n.texSubImage2D(r.TEXTURE_2D,Tt,0,0,Ot.width,Ot.height,wt,Yt,Ot.data):n.texImage2D(r.TEXTURE_2D,Tt,It,Ot.width,Ot.height,0,wt,Yt,Ot.data)}else if(E.isDataArrayTexture)if(W){if(zt&&n.texStorage3D(r.TEXTURE_2D_ARRAY,kt,It,bt.width,bt.height,bt.depth),Ct)if(E.layerUpdates.size>0){const Tt=Z_(bt.width,bt.height,E.format,E.type);for(const yt of E.layerUpdates){const Nt=bt.data.subarray(yt*Tt/bt.data.BYTES_PER_ELEMENT,(yt+1)*Tt/bt.data.BYTES_PER_ELEMENT);n.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,yt,bt.width,bt.height,1,wt,Yt,Nt)}E.clearLayerUpdates()}else n.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,bt.width,bt.height,bt.depth,wt,Yt,bt.data)}else n.texImage3D(r.TEXTURE_2D_ARRAY,0,It,bt.width,bt.height,bt.depth,0,wt,Yt,bt.data);else if(E.isData3DTexture)W?(zt&&n.texStorage3D(r.TEXTURE_3D,kt,It,bt.width,bt.height,bt.depth),Ct&&n.texSubImage3D(r.TEXTURE_3D,0,0,0,0,bt.width,bt.height,bt.depth,wt,Yt,bt.data)):n.texImage3D(r.TEXTURE_3D,0,It,bt.width,bt.height,bt.depth,0,wt,Yt,bt.data);else if(E.isFramebufferTexture){if(zt)if(W)n.texStorage2D(r.TEXTURE_2D,kt,It,bt.width,bt.height);else{let Tt=bt.width,yt=bt.height;for(let Nt=0;Nt<kt;Nt++)n.texImage2D(r.TEXTURE_2D,Nt,It,Tt,yt,0,wt,Yt,null),Tt>>=1,yt>>=1}}else if(_e.length>0){if(W&&zt){const Tt=Lt(_e[0]);n.texStorage2D(r.TEXTURE_2D,kt,It,Tt.width,Tt.height)}for(let Tt=0,yt=_e.length;Tt<yt;Tt++)Ot=_e[Tt],W?Ct&&n.texSubImage2D(r.TEXTURE_2D,Tt,0,0,wt,Yt,Ot):n.texImage2D(r.TEXTURE_2D,Tt,It,wt,Yt,Ot);E.generateMipmaps=!1}else if(W){if(zt){const Tt=Lt(bt);n.texStorage2D(r.TEXTURE_2D,kt,It,Tt.width,Tt.height)}Ct&&n.texSubImage2D(r.TEXTURE_2D,0,0,0,wt,Yt,bt)}else n.texImage2D(r.TEXTURE_2D,0,It,wt,Yt,bt);M(E)&&x(ut),Zt.__version=ft.version,E.onUpdate&&E.onUpdate(E)}N.__version=E.version}function dt(N,E,X){if(E.image.length!==6)return;const ut=ot(N,E),mt=E.source;n.bindTexture(r.TEXTURE_CUBE_MAP,N.__webglTexture,r.TEXTURE0+X);const ft=s.get(mt);if(mt.version!==ft.__version||ut===!0){n.activeTexture(r.TEXTURE0+X);const Zt=Ne.getPrimaries(Ne.workingColorSpace),Ut=E.colorSpace===us?null:Ne.getPrimaries(E.colorSpace),jt=E.colorSpace===us||Zt===Ut?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,E.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,E.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,jt);const se=E.isCompressedTexture||E.image[0].isCompressedTexture,bt=E.image[0]&&E.image[0].isDataTexture,wt=[];for(let yt=0;yt<6;yt++)!se&&!bt?wt[yt]=A(E.image[yt],!0,l.maxCubemapSize):wt[yt]=bt?E.image[yt].image:E.image[yt],wt[yt]=ie(E,wt[yt]);const Yt=wt[0],It=c.convert(E.format,E.colorSpace),Ot=c.convert(E.type),_e=D(E.internalFormat,It,Ot,E.colorSpace),W=E.isVideoTexture!==!0,zt=ft.__version===void 0||ut===!0,Ct=mt.dataReady;let kt=H(E,Yt);$(r.TEXTURE_CUBE_MAP,E);let Tt;if(se){W&&zt&&n.texStorage2D(r.TEXTURE_CUBE_MAP,kt,_e,Yt.width,Yt.height);for(let yt=0;yt<6;yt++){Tt=wt[yt].mipmaps;for(let Nt=0;Nt<Tt.length;Nt++){const ue=Tt[Nt];E.format!==Oi?It!==null?W?Ct&&n.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Nt,0,0,ue.width,ue.height,It,ue.data):n.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Nt,_e,ue.width,ue.height,0,ue.data):he("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):W?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Nt,0,0,ue.width,ue.height,It,Ot,ue.data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Nt,_e,ue.width,ue.height,0,It,Ot,ue.data)}}}else{if(Tt=E.mipmaps,W&&zt){Tt.length>0&&kt++;const yt=Lt(wt[0]);n.texStorage2D(r.TEXTURE_CUBE_MAP,kt,_e,yt.width,yt.height)}for(let yt=0;yt<6;yt++)if(bt){W?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,0,0,wt[yt].width,wt[yt].height,It,Ot,wt[yt].data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,_e,wt[yt].width,wt[yt].height,0,It,Ot,wt[yt].data);for(let Nt=0;Nt<Tt.length;Nt++){const Ue=Tt[Nt].image[yt].image;W?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Nt+1,0,0,Ue.width,Ue.height,It,Ot,Ue.data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Nt+1,_e,Ue.width,Ue.height,0,It,Ot,Ue.data)}}else{W?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,0,0,It,Ot,wt[yt]):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,_e,It,Ot,wt[yt]);for(let Nt=0;Nt<Tt.length;Nt++){const ue=Tt[Nt];W?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Nt+1,0,0,It,Ot,ue.image[yt]):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Nt+1,_e,It,Ot,ue.image[yt])}}}M(E)&&x(r.TEXTURE_CUBE_MAP),ft.__version=mt.version,E.onUpdate&&E.onUpdate(E)}N.__version=E.version}function Dt(N,E,X,ut,mt,ft){const Zt=c.convert(X.format,X.colorSpace),Ut=c.convert(X.type),jt=D(X.internalFormat,Zt,Ut,X.colorSpace),se=s.get(E),bt=s.get(X);if(bt.__renderTarget=E,!se.__hasExternalTextures){const wt=Math.max(1,E.width>>ft),Yt=Math.max(1,E.height>>ft);mt===r.TEXTURE_3D||mt===r.TEXTURE_2D_ARRAY?n.texImage3D(mt,ft,jt,wt,Yt,E.depth,0,Zt,Ut,null):n.texImage2D(mt,ft,jt,wt,Yt,0,Zt,Ut,null)}n.bindFramebuffer(r.FRAMEBUFFER,N),ne(E)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,ut,mt,bt.__webglTexture,0,P(E)):(mt===r.TEXTURE_2D||mt>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&mt<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,ut,mt,bt.__webglTexture,ft),n.bindFramebuffer(r.FRAMEBUFFER,null)}function Vt(N,E,X){if(r.bindRenderbuffer(r.RENDERBUFFER,N),E.depthBuffer){const ut=E.depthTexture,mt=ut&&ut.isDepthTexture?ut.type:null,ft=L(E.stencilBuffer,mt),Zt=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;ne(E)?h.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,P(E),ft,E.width,E.height):X?r.renderbufferStorageMultisample(r.RENDERBUFFER,P(E),ft,E.width,E.height):r.renderbufferStorage(r.RENDERBUFFER,ft,E.width,E.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Zt,r.RENDERBUFFER,N)}else{const ut=E.textures;for(let mt=0;mt<ut.length;mt++){const ft=ut[mt],Zt=c.convert(ft.format,ft.colorSpace),Ut=c.convert(ft.type),jt=D(ft.internalFormat,Zt,Ut,ft.colorSpace);ne(E)?h.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,P(E),jt,E.width,E.height):X?r.renderbufferStorageMultisample(r.RENDERBUFFER,P(E),jt,E.width,E.height):r.renderbufferStorage(r.RENDERBUFFER,jt,E.width,E.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Wt(N,E,X){const ut=E.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(r.FRAMEBUFFER,N),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const mt=s.get(E.depthTexture);if(mt.__renderTarget=E,(!mt.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),ut){if(mt.__webglInit===void 0&&(mt.__webglInit=!0,E.depthTexture.addEventListener("dispose",B)),mt.__webglTexture===void 0){mt.__webglTexture=r.createTexture(),n.bindTexture(r.TEXTURE_CUBE_MAP,mt.__webglTexture),$(r.TEXTURE_CUBE_MAP,E.depthTexture);const se=c.convert(E.depthTexture.format),bt=c.convert(E.depthTexture.type);let wt;E.depthTexture.format===Ca?wt=r.DEPTH_COMPONENT24:E.depthTexture.format===Gs&&(wt=r.DEPTH24_STENCIL8);for(let Yt=0;Yt<6;Yt++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Yt,0,wt,E.width,E.height,0,se,bt,null)}}else at(E.depthTexture,0);const ft=mt.__webglTexture,Zt=P(E),Ut=ut?r.TEXTURE_CUBE_MAP_POSITIVE_X+X:r.TEXTURE_2D,jt=E.depthTexture.format===Gs?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(E.depthTexture.format===Ca)ne(E)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,jt,Ut,ft,0,Zt):r.framebufferTexture2D(r.FRAMEBUFFER,jt,Ut,ft,0);else if(E.depthTexture.format===Gs)ne(E)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,jt,Ut,ft,0,Zt):r.framebufferTexture2D(r.FRAMEBUFFER,jt,Ut,ft,0);else throw new Error("Unknown depthTexture format")}function pe(N){const E=s.get(N),X=N.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==N.depthTexture){const ut=N.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ut){const mt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ut.removeEventListener("dispose",mt)};ut.addEventListener("dispose",mt),E.__depthDisposeCallback=mt}E.__boundDepthTexture=ut}if(N.depthTexture&&!E.__autoAllocateDepthBuffer)if(X)for(let ut=0;ut<6;ut++)Wt(E.__webglFramebuffer[ut],N,ut);else{const ut=N.texture.mipmaps;ut&&ut.length>0?Wt(E.__webglFramebuffer[0],N,0):Wt(E.__webglFramebuffer,N,0)}else if(X){E.__webglDepthbuffer=[];for(let ut=0;ut<6;ut++)if(n.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer[ut]),E.__webglDepthbuffer[ut]===void 0)E.__webglDepthbuffer[ut]=r.createRenderbuffer(),Vt(E.__webglDepthbuffer[ut],N,!1);else{const mt=N.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ft=E.__webglDepthbuffer[ut];r.bindRenderbuffer(r.RENDERBUFFER,ft),r.framebufferRenderbuffer(r.FRAMEBUFFER,mt,r.RENDERBUFFER,ft)}}else{const ut=N.texture.mipmaps;if(ut&&ut.length>0?n.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer[0]):n.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=r.createRenderbuffer(),Vt(E.__webglDepthbuffer,N,!1);else{const mt=N.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ft=E.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,ft),r.framebufferRenderbuffer(r.FRAMEBUFFER,mt,r.RENDERBUFFER,ft)}}n.bindFramebuffer(r.FRAMEBUFFER,null)}function ge(N,E,X){const ut=s.get(N);E!==void 0&&Dt(ut.__webglFramebuffer,N,N.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),X!==void 0&&pe(N)}function fe(N){const E=N.texture,X=s.get(N),ut=s.get(E);N.addEventListener("dispose",O);const mt=N.textures,ft=N.isWebGLCubeRenderTarget===!0,Zt=mt.length>1;if(Zt||(ut.__webglTexture===void 0&&(ut.__webglTexture=r.createTexture()),ut.__version=E.version,u.memory.textures++),ft){X.__webglFramebuffer=[];for(let Ut=0;Ut<6;Ut++)if(E.mipmaps&&E.mipmaps.length>0){X.__webglFramebuffer[Ut]=[];for(let jt=0;jt<E.mipmaps.length;jt++)X.__webglFramebuffer[Ut][jt]=r.createFramebuffer()}else X.__webglFramebuffer[Ut]=r.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){X.__webglFramebuffer=[];for(let Ut=0;Ut<E.mipmaps.length;Ut++)X.__webglFramebuffer[Ut]=r.createFramebuffer()}else X.__webglFramebuffer=r.createFramebuffer();if(Zt)for(let Ut=0,jt=mt.length;Ut<jt;Ut++){const se=s.get(mt[Ut]);se.__webglTexture===void 0&&(se.__webglTexture=r.createTexture(),u.memory.textures++)}if(N.samples>0&&ne(N)===!1){X.__webglMultisampledFramebuffer=r.createFramebuffer(),X.__webglColorRenderbuffer=[],n.bindFramebuffer(r.FRAMEBUFFER,X.__webglMultisampledFramebuffer);for(let Ut=0;Ut<mt.length;Ut++){const jt=mt[Ut];X.__webglColorRenderbuffer[Ut]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,X.__webglColorRenderbuffer[Ut]);const se=c.convert(jt.format,jt.colorSpace),bt=c.convert(jt.type),wt=D(jt.internalFormat,se,bt,jt.colorSpace,N.isXRRenderTarget===!0),Yt=P(N);r.renderbufferStorageMultisample(r.RENDERBUFFER,Yt,wt,N.width,N.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ut,r.RENDERBUFFER,X.__webglColorRenderbuffer[Ut])}r.bindRenderbuffer(r.RENDERBUFFER,null),N.depthBuffer&&(X.__webglDepthRenderbuffer=r.createRenderbuffer(),Vt(X.__webglDepthRenderbuffer,N,!0)),n.bindFramebuffer(r.FRAMEBUFFER,null)}}if(ft){n.bindTexture(r.TEXTURE_CUBE_MAP,ut.__webglTexture),$(r.TEXTURE_CUBE_MAP,E);for(let Ut=0;Ut<6;Ut++)if(E.mipmaps&&E.mipmaps.length>0)for(let jt=0;jt<E.mipmaps.length;jt++)Dt(X.__webglFramebuffer[Ut][jt],N,E,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,jt);else Dt(X.__webglFramebuffer[Ut],N,E,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,0);M(E)&&x(r.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Zt){for(let Ut=0,jt=mt.length;Ut<jt;Ut++){const se=mt[Ut],bt=s.get(se);let wt=r.TEXTURE_2D;(N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(wt=N.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),n.bindTexture(wt,bt.__webglTexture),$(wt,se),Dt(X.__webglFramebuffer,N,se,r.COLOR_ATTACHMENT0+Ut,wt,0),M(se)&&x(wt)}n.unbindTexture()}else{let Ut=r.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Ut=N.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),n.bindTexture(Ut,ut.__webglTexture),$(Ut,E),E.mipmaps&&E.mipmaps.length>0)for(let jt=0;jt<E.mipmaps.length;jt++)Dt(X.__webglFramebuffer[jt],N,E,r.COLOR_ATTACHMENT0,Ut,jt);else Dt(X.__webglFramebuffer,N,E,r.COLOR_ATTACHMENT0,Ut,0);M(E)&&x(Ut),n.unbindTexture()}N.depthBuffer&&pe(N)}function xt(N){const E=N.textures;for(let X=0,ut=E.length;X<ut;X++){const mt=E[X];if(M(mt)){const ft=z(N),Zt=s.get(mt).__webglTexture;n.bindTexture(ft,Zt),x(ft),n.unbindTexture()}}}const At=[],Et=[];function Ft(N){if(N.samples>0){if(ne(N)===!1){const E=N.textures,X=N.width,ut=N.height;let mt=r.COLOR_BUFFER_BIT;const ft=N.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Zt=s.get(N),Ut=E.length>1;if(Ut)for(let se=0;se<E.length;se++)n.bindFramebuffer(r.FRAMEBUFFER,Zt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+se,r.RENDERBUFFER,null),n.bindFramebuffer(r.FRAMEBUFFER,Zt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+se,r.TEXTURE_2D,null,0);n.bindFramebuffer(r.READ_FRAMEBUFFER,Zt.__webglMultisampledFramebuffer);const jt=N.texture.mipmaps;jt&&jt.length>0?n.bindFramebuffer(r.DRAW_FRAMEBUFFER,Zt.__webglFramebuffer[0]):n.bindFramebuffer(r.DRAW_FRAMEBUFFER,Zt.__webglFramebuffer);for(let se=0;se<E.length;se++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(mt|=r.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(mt|=r.STENCIL_BUFFER_BIT)),Ut){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Zt.__webglColorRenderbuffer[se]);const bt=s.get(E[se]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,bt,0)}r.blitFramebuffer(0,0,X,ut,0,0,X,ut,mt,r.NEAREST),m===!0&&(At.length=0,Et.length=0,At.push(r.COLOR_ATTACHMENT0+se),N.depthBuffer&&N.resolveDepthBuffer===!1&&(At.push(ft),Et.push(ft),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Et)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,At))}if(n.bindFramebuffer(r.READ_FRAMEBUFFER,null),n.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),Ut)for(let se=0;se<E.length;se++){n.bindFramebuffer(r.FRAMEBUFFER,Zt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+se,r.RENDERBUFFER,Zt.__webglColorRenderbuffer[se]);const bt=s.get(E[se]).__webglTexture;n.bindFramebuffer(r.FRAMEBUFFER,Zt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+se,r.TEXTURE_2D,bt,0)}n.bindFramebuffer(r.DRAW_FRAMEBUFFER,Zt.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&m){const E=N.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[E])}}}function P(N){return Math.min(l.maxSamples,N.samples)}function ne(N){const E=s.get(N);return N.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function Ht(N){const E=u.render.frame;_.get(N)!==E&&(_.set(N,E),N.update())}function ie(N,E){const X=N.colorSpace,ut=N.format,mt=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||X!==jr&&X!==us&&(Ne.getTransfer(X)===ke?(ut!==Oi||mt!==ci)&&he("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Le("WebGLTextures: Unsupported texture color space:",X)),E}function Lt(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(p.width=N.naturalWidth||N.width,p.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(p.width=N.displayWidth,p.height=N.displayHeight):(p.width=N.width,p.height=N.height),p}this.allocateTextureUnit=tt,this.resetTextureUnits=j,this.setTexture2D=at,this.setTexture2DArray=F,this.setTexture3D=G,this.setTextureCube=K,this.rebindTextures=ge,this.setupRenderTarget=fe,this.updateRenderTargetMipmap=xt,this.updateMultisampleRenderTarget=Ft,this.setupDepthRenderbuffer=pe,this.setupFrameBufferTexture=Dt,this.useMultisampledRTT=ne,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function yR(r,t){function n(s,l=us){let c;const u=Ne.getTransfer(l);if(s===ci)return r.UNSIGNED_BYTE;if(s===rp)return r.UNSIGNED_SHORT_4_4_4_4;if(s===op)return r.UNSIGNED_SHORT_5_5_5_1;if(s===Uv)return r.UNSIGNED_INT_5_9_9_9_REV;if(s===Ov)return r.UNSIGNED_INT_10F_11F_11F_REV;if(s===Lv)return r.BYTE;if(s===Nv)return r.SHORT;if(s===ll)return r.UNSIGNED_SHORT;if(s===sp)return r.INT;if(s===Zi)return r.UNSIGNED_INT;if(s===Xi)return r.FLOAT;if(s===Ra)return r.HALF_FLOAT;if(s===Pv)return r.ALPHA;if(s===zv)return r.RGB;if(s===Oi)return r.RGBA;if(s===Ca)return r.DEPTH_COMPONENT;if(s===Gs)return r.DEPTH_STENCIL;if(s===Fv)return r.RED;if(s===lp)return r.RED_INTEGER;if(s===Yr)return r.RG;if(s===cp)return r.RG_INTEGER;if(s===up)return r.RGBA_INTEGER;if(s===Jc||s===$c||s===tu||s===eu)if(u===ke)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===Jc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===$c)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===tu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===eu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===Jc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===$c)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===tu)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===eu)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===xd||s===Sd||s===yd||s===Md)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===xd)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Sd)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===yd)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Md)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Ed||s===bd||s===Td||s===Ad||s===Rd||s===Cd||s===wd)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(s===Ed||s===bd)return u===ke?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===Td)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC;if(s===Ad)return c.COMPRESSED_R11_EAC;if(s===Rd)return c.COMPRESSED_SIGNED_R11_EAC;if(s===Cd)return c.COMPRESSED_RG11_EAC;if(s===wd)return c.COMPRESSED_SIGNED_RG11_EAC}else return null;if(s===Dd||s===Ld||s===Nd||s===Ud||s===Od||s===Pd||s===zd||s===Fd||s===Id||s===Bd||s===Hd||s===Gd||s===Vd||s===kd)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(s===Dd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Ld)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Nd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Ud)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===Od)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Pd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===zd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Fd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Id)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Bd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Hd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Gd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Vd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===kd)return u===ke?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Xd||s===Wd||s===qd)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(s===Xd)return u===ke?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Wd)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===qd)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Yd||s===jd||s===Zd||s===Kd)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(s===Yd)return c.COMPRESSED_RED_RGTC1_EXT;if(s===jd)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Zd)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Kd)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===cl?r.UNSIGNED_INT_24_8:r[s]!==void 0?r[s]:null}return{convert:n}}const MR=`
void main() {

const e=`export declare const TYPES_VERSION = "0.5.52";
...
export declare enum AirPurifierStatus {
    Inactive = "Inactive",
    Idle = "Idle",
    Active = "Active",
    ActiveNightMode = "ActiveNightMode"
}
export declare enum AirPurifierMode {
    Manual = "Manual",
    Automatic = "Automatic"
}
...
export type SerializableType = null | undefined | boolean | number | string | {
...
export interface Setting {
    ...
    description?: string;
    placeholder?: string;
    type?: 'string' | 'password' | 'number' | 'boolean' | 'device' | 'integer' | 'button' | 'clippath' | 'interface' | 'html' | 'textarea' | 'date' | 'time' | 'datetime' | 'day' | 'timerange' | 'daterange' | 'datetimerange' | 'radiobutton' | 'radiopanel' | 'script';
    /**
